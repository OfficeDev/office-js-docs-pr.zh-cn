...
## <a name="change-the-state-in-response-to-an-event"></a><span data-ttu-id="82f7a-153">更改状态以响应事件</span><span class="sxs-lookup"><span data-stu-id="82f7a-153">Change the state in response to an event</span></span>
