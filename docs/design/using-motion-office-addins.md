# <a name="using-motion-in-office-add-ins"></a><span data-ttu-id="f0b21-101">在 Office 加载项中使用动作</span><span class="sxs-lookup"><span data-stu-id="f0b21-101">Using motion in Office add-ins</span></span>
