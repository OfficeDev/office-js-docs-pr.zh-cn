# <a name="using-motion-in-office-add-ins"></a><span data-ttu-id="25f0b-101">在 Office 外接程序中使用动作</span><span class="sxs-lookup"><span data-stu-id="25f0b-101">Using motion in Office add-ins</span></span>
