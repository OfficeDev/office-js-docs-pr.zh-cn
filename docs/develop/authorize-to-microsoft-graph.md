...
用户使用个人 Microsoft 帐户或其 Microsoft 365 教育版或工作帐户) 登录 Office (online、移动和桌面平台。 在 Office 加载项中获取对 [Microsoft Graph](https://developer.microsoft.com/graph/docs) 的访问权限的最佳方式是使用用户的 Office 登录凭据。 这使用户能够访问其 Microsoft Graph 数据，而无需再次登录。
