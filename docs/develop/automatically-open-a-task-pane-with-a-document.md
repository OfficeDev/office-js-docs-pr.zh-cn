...
某些情况下，需要在文档打开时自动打开一个任务窗格，而无需进行显式用户交互。 您可以使用 [AddInCommands 1.1](/javascript/api/requirement-sets/add-in-commands-requirement-sets) 要求集引入的 Autoopen 任务窗格功能，以在方案需要时自动打开任务窗格。
