...
也可使用 [Visual Studio](../get-started/create-and-debug-office-add-ins-in-visual-studio.md) 或[任意编辑器](../get-started/create-an-office-add-in-using-any-editor.md)创建适用于 PowerPoint 或 Word 的外接程序。 
