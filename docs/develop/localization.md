...
> 
  **注意**：只能本地化 Office 支持的区域设置的说明和显示名称。有关最新版 Office 支持的语言和区域设置列表，请参阅 [Office 2013 中的语言标识符和 OptionState ID 值](http://technet.microsoft.com/zh-cn/library/cc179219.aspx)。
