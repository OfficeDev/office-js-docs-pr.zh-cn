...
Web 应用程序和 Office 加载项默认允许匿名访问，但你可要求用户通过登录进行身份验证。 具体而言，你可要求用户使用 Microsoft 帐户或工作/学校 (Office 365) 帐户登录。 此任务被称为“用户身份验证”，因为它让加载项能够知道用户的身份。
