...
|**权限**|**启用的 API 子集**|
|:-----|:-----|
|**受限**|[Settings](http://dev.office.com/reference/add-ins/shared/settings) 对象的方法和 [Document.getActiveViewAsync](../../reference/shared/document.getactiveviewasync.md) 方法。这是内容或任务窗格加载项可以请求的最低级别权限。|
