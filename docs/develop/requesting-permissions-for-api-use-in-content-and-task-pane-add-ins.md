...
|**ReadDocument**|除了**受限制**权限允许的 api，添加对 api 成员的访问权限，以读取文档和管理绑定。这包括使用：<br/><ul><li>
