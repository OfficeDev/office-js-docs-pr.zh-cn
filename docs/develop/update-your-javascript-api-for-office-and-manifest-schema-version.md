...
以下步骤将更新Office.js库文件到最新版本。 这些步骤使用 Visual Studio 2019，但它们与早期版本的 Visual Studio 类似。
...
你无需本地 Office JavaScript API 文件 (Office.js 和特定于应用的 .js 文件) 来开发引用 CDN for Office.js 的Office 外接程序 (在运行时) 下载必要的文件，但是如果你想要库文件的本地副本，可以使用[NuGet Command-Line](https://docs.nuget.org/consume/installing-nuget)实用工具和命令下载它们。 `Install-Package Microsoft.Office.js`
