...
|`ApiNotFound`|找不到您尝试使用的 API。 它可能在更高版本的 Excel 中提供。 有关详细信息[，Excel JavaScript API](/javascript/api/requirement-sets/excel/excel-api-requirement-sets) 要求集文章。| |
