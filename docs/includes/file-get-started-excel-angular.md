# <a name="build-an-excel-add-in-using-angular"></a><span data-ttu-id="36a7d-101">使用 Angular 生成 Excel 加载项</span><span class="sxs-lookup"><span data-stu-id="36a7d-101">Build an Excel add-in using Angular</span></span>
