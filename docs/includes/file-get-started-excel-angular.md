# <a name="build-an-excel-add-in-using-angular"></a><span data-ttu-id="1f1c2-101">使用 Angular 生成 Excel 加载项</span><span class="sxs-lookup"><span data-stu-id="1f1c2-101">Build an Excel add-in using Angular</span></span>
