# <a name="build-an-excel-add-in-using-react"></a><span data-ttu-id="71ab7-101">使用 React 生成 Excel 加载项</span><span class="sxs-lookup"><span data-stu-id="71ab7-101">Build an Excel add-in using React</span></span>
