[要求集](../develop/office-versions-and-requirement-sets.md) 是已命名的 API 成员组。要求集可特定于 Office 应用程序，例如 `ExcelApi 1.7` 要求集（一组仅可在 Excel 中使用的 API），也可通用于多个应用程序，例如 `DialogApi 1.1` 要求集（一组可在支持对话框 API 的任何 Office 应用程序中使用的 API）。
