<span data-ttu-id="49d2c-101">本教程的这一步是，检索选定幻灯片的元数据。</span><span class="sxs-lookup"><span data-stu-id="49d2c-101">In this step of the tutorial, you'll retrieve metadata for the selected slide.</span></span>
