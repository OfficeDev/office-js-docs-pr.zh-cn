- <span data-ttu-id="fff96-101">[Node.js](https://nodejs.org)（版本 8.0.0 或更高版本）</span><span class="sxs-lookup"><span data-stu-id="fff96-101">[Node.js](https://nodejs.org) (version 8.0.0 or later)</span></span>
