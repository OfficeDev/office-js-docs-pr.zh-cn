<span data-ttu-id="1ab14-101">运行以下命令，使用 Yeoman 生成器创建加载项项目：</span><span class="sxs-lookup"><span data-stu-id="1ab14-101">Run the following command to create an add-in project using the Yeoman generator:</span></span> 
