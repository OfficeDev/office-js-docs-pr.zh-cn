...
ms.locfileid: "44609104"
---
# <a name="outlook-add-ins-documentation"></a>Outlook 加载项文档

借助 Outlook 加载项，你可以使用熟悉的 Web 技术（如 HTML、CSS 和 JavaScript）来构建一个可跨多个平台（包括在 Windows、Mac、iPad 和 Web 上）在 Outlook 中运行的解决方案。 了解如何构建、测试、调试和发布 Outlook 加载项。
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>测试和调试</h3>
                        <p><a href="../testing/test-debug-office-add-ins.md">了解如何测试和调试 Outlook 加载项。</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>发布</h3>
                        <p><a href="../publish/publish.md">了解如何部署和发布 Outlook 加载项。</a></p>
                    </div>
                </div>
            </div>
        </div>
