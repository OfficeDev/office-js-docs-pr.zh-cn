...
设置联机会议是 Outlook 用户的核心体验，使用移动设备轻松创建Teams会议[Outlook](/microsoftteams/teams-add-in-for-outlook)体验。 但是，使用非 Microsoft 服务Outlook联机会议可能会很麻烦。 通过实现此功能，服务提供商可以简化其外接程序用户的联机会议Outlook体验。
