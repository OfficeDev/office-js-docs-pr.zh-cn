...
ms.openlocfilehash: 0e5a33d279644579bd6a410842528c13d5a32fa0
ms.sourcegitcommit: 1306faba8694dea203373972b6ff2e852429a119
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/12/2021
ms.locfileid: "59149488"
---
...
- 如果检测到当前应用程序是 Outlook 网页版 移动设备，则该方法将采用 UTC 格式的表示形式转换为 EAC 时区中的字典格式，与 Outlook 网页版 或移动设备用户界面的其余部分保持一 `convertToLocalClientTime` `Date` 致。
