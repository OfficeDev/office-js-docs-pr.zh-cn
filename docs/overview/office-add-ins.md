...
- 单一登录 (SSO)：Office 加载项可以与用户的 Office 365 帐户轻松集成。 
...
有关 Outlook 加载项的概述，请参阅 [Outlook 加载项概述](https://docs.microsoft.com/zh-cn/outlook/add-ins/)。 
...
若要详细了解如何开始生成 Office 加载项，请尝试阅读 [5 分钟快速入门](https://docs.microsoft.com/zh-cn/office/dev/add-ins/)。可以使用 Visual Studio 或其他任何编辑器，立即开始生成加载项。 
...
- [Office 加载项示例](https://dev.office.com/code-samples)
