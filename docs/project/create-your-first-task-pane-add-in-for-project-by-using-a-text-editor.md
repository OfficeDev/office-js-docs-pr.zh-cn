...
你可以使用适用于 Office 加载项的 Yeoman 生成器为 Project Standard 2013、Project Professional 2013 或更高版本创建任务窗格加载项。本文介绍如何创建一个简单的加载项，该加载项使用指向文件共享上的 HTML 文件的 XML 清单。 Project OM Test 示例加载项用于测试一些 JavaScript 功能，这些功能为加载项使用对象模型。使用 Project 中的“信任中心”**** 注册包含清单文件的文件共享后，你可以从功能区上的“Project”**** 选项卡打开任务窗格加载项。 （本文中的示例代码基于 Microsoft Corporation 的 Arvind lyer 所做的测试应用程序。）
