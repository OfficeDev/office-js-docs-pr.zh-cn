...
请考虑分阶段部署 Office 加载项，以确保部署顺利进行。我们建议使用以下计划：
...
3. 在导航菜单中，按 **“显示更多”**，然后选择 **“设置”** > **“服务和加载项”**。
...
8.  如果选择了从 Office 应用商店添加加载项的选项，请选择相应的加载项。 你可以通过 **“为你推荐”** 、**   “评级”** 或** “名称”** 类别，查看可用的加载项。 你只能通过 Office 应用商店添加免费加载项。 当前不支持添加付费加载项。

    > [!NOTE]
    > 使用 Office 应用商店选项时，无需干预，即会自动向用户提供加载项的更新程序和增强功能。
...
10. 在 **“编辑谁有权访问”** 页面上，选择 **“每个人”**、**“特定的用户/组”** 或 **“只有我”**。 使用“搜索”框查找想要为其部署加载项的用户和组。
...
11. 完成后，选择 **“保存”** 以保存清单。 此过程可能最多需要三分钟。 然后，通过按 **“下一步”** 完成本演练。 现在，可以看到此加载项与其他应用一起显示在 Office 365 中。
...
1.  在 Word 2016 或更高版本，Excel 2016 或更高版本或 PowerPoint 2016 或更高版本，选择 **插入** > **我加载项**。
...
- [确定加载项的集中式部署是否适用于你的 Office 365 组织](https://support.office.com/article/Determine-if-Centralized-Deployment-of-add-ins-works-for-your-Office-365-organization-b4527d49-4073-4b43-8274-31b7a3166f92)
