...
![适用于 Office 加载项命令行接口的 Yeoman 生成器。](../images/yo-office-excel.png)
...
1. 在 Excel 中，依次选择的“**开始**”选项卡和功能区中的“**显示任务窗格**”按钮，以打开加载项任务窗格。
    ...
    ![Excel 主页菜单，突出显示了“显示任务窗格”按钮。](../images/excel-quickstart-addin-3b.png)

1. 选择工作表中的任何一系列单元格。

1. 在任务窗格的底部，选择“**运行**”链接，价格选定范围的颜色设为黄色。

    ![Excel 中加载项任务窗格处于打开状态，并且加载项任务窗格中突出显示“运行”按钮。](../images/excel-quickstart-addin-3c.png)
...
1. 打开 Web 应用项目根目录中的文件“Home.css”****。 此文件指定加载项自定义样式。 将整个内容替换为以下代码，并保存文件。
...
1. `DisplayName` 元素的 `DefaultValue` 属性有占位符。 将它替换为“My Office Add-in”。

1. `Description` 元素的 `DefaultValue` 属性有占位符。 将它替换为“A task pane add-in for Excel”。
...
1. 在 Excel 中，依次选择的“**开始**”选项卡和功能区中的“**显示任务窗格**”按钮，以打开加载项任务窗格。
    ...
    ![Excel 主页菜单，突出显示了“显示任务窗格”按钮。](../images/excel-quickstart-addin-2a.png)

1. 选择工作表中的任何一系列单元格。

1. 在任务窗格中，选择“**设置颜色**”按钮，将选定区域的颜色设置为绿色。

    ![加载项任务窗格在 Excel 中打开。](../images/excel-quickstart-addin-2c.png)
