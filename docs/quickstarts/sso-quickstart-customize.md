...
### <a name="changes-required-for-an-outlook-add-in-javascript"></a>JavaScript Outlook加载项 (更改) 
...
4. 在任务窗格底部，选择"读取 **我的** OneDrive for Business"按钮以启动 SSO 过程。
...
5. 在任务窗格底部，选择"读取 **我的** OneDrive for Business"按钮以启动 SSO 过程。
