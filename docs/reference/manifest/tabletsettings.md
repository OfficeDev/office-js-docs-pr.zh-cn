...
> [!IMPORTANT]
> 此元素仅适用于经典Outlook 网页版 (通常连接到旧版本地 Exchange 服务器) Outlook `TabletSettings` 2013 Windows。 若要支持Outlook Android 和 iOS 上的加载项，请参阅适用于[Outlook Mobile 的外接程序](../../outlook/outlook-mobile-addins.md)。
