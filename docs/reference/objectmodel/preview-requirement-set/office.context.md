...
|---|---|---|:---:|
| [认证](#auth-auth) | 撰写<br>阅读 | [Auth](/javascript/api/office/office.auth?view=outlook-js-preview&preserve-view=true) | [IdentityAPI 1。3](../../requirement-sets/identity-api-requirement-sets.md) |
