...
- 修改了[OfficeRuntime.存储：Outlook](/javascript/api/office-runtime/officeruntime.storage?view=outlook-js-1.10&preserve-view=true)仅支持基于事件的激活功能。
