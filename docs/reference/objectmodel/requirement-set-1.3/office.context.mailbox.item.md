...
#### <a name="attachments-arrayattachmentdetailsjavascriptapioutlookofficeattachmentdetailsviewoutlook-js-13"></a>attachments: Array.<[AttachmentDetails](/javascript/api/outlook/office.attachmentdetails?view=outlook-js-1.3)>
...
#### <a name="bcc-recipientsjavascriptapioutlookofficerecipientsviewoutlook-js-13"></a>bcc: [Recipients](/javascript/api/outlook/office.recipients?view=outlook-js-1.3)
...
#### <a name="body-bodyjavascriptapioutlookofficebodyviewoutlook-js-13"></a>body: [Body](/javascript/api/outlook/office.body?view=outlook-js-1.3)
...
#### <a name="end-datetimejavascriptapioutlookofficetimeviewoutlook-js-13"></a>end: Date|[Time](/javascript/api/outlook/office.time?view=outlook-js-1.3)
...
#### <a name="from-emailaddressdetailsjavascriptapioutlookofficeemailaddressdetailsviewoutlook-js-13"></a>from: [EmailAddressDetails](/javascript/api/outlook/office.emailaddressdetails?view=outlook-js-1.3)
...
获取当前项的[Exchange Web 服务项标识符](/exchange/client-developer/exchange-web-services/ews-identifiers-in-exchange)。仅读取模式。
...
#### <a name="location-stringlocationjavascriptapioutlookofficelocationviewoutlook-js-13"></a>location: String|[Location](/javascript/api/outlook/office.location?view=outlook-js-1.3)
...
#### <a name="organizer-emailaddressdetailsjavascriptapioutlookofficeemailaddressdetailsviewoutlook-js-13"></a>organizer: [EmailAddressDetails](/javascript/api/outlook/office.emailaddressdetails?view=outlook-js-1.3)
...
#### <a name="sender-emailaddressdetailsjavascriptapioutlookofficeemailaddressdetailsviewoutlook-js-13"></a>sender: [EmailAddressDetails](/javascript/api/outlook/office.emailaddressdetails?view=outlook-js-1.3)
...
#### <a name="start-datetimejavascriptapioutlookofficetimeviewoutlook-js-13"></a>start: Date|[Time](/javascript/api/outlook/office.time?view=outlook-js-1.3)
...
#### <a name="subject-stringsubjectjavascriptapioutlookofficesubjectviewoutlook-js-13"></a>subject: String|[Subject](/javascript/api/outlook/office.subject?view=outlook-js-1.3)
