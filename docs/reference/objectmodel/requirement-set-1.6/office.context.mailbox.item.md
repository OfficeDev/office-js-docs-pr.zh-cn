...
`item`命名空间用于访问当前选定的邮件、会议请求或安排。可以通过使用[itemType](#itemtype-officemailboxenumsitemtypejavascriptapioutlook16officemailboxenumsitemtype)属性确定`item`的类型。

##### <a name="requirements"></a>要求

|要求| 值|
|---|---|
|[最低邮箱要求设置版本](/javascript/office/requirement-sets/outlook-api-requirement-sets)| 1.0|
...
| 成员 | 类型 |
|--------|------|
| [attachments](#attachments-arrayattachmentdetailsjavascriptapioutlook16officeattachmentdetails) | 成员 |
| [bcc](#bcc-recipientsjavascriptapioutlook16officerecipients) | 成员 |
| [body](#body-bodyjavascriptapioutlook16officebody) | 成员 |
| [cc](#cc-arrayemailaddressdetailsjavascriptapioutlook16officeemailaddressdetailsrecipientsjavascriptapioutlook16officerecipients) | 成员 |
...
| [end](#end-datetimejavascriptapioutlook16officetime) | 成员 |
| [from](#from-emailaddressdetailsjavascriptapioutlook16officeemailaddressdetails) | 成员 |
| [internetMessageId](#internetmessageid-string) | 成员 |
| [itemClass](#itemclass-string) | 成员 |
| [itemId](#nullable-itemid-string) | 成员 |
| [itemType](#itemtype-officemailboxenumsitemtypejavascriptapioutlook16officemailboxenumsitemtype) | 成员 |
| [location](#location-stringlocationjavascriptapioutlook16officelocation) | 成员 |
| [normalizedSubject](#normalizedsubject-string) | 成员 |
| [notificationMessages](#notificationmessages-notificationmessagesjavascriptapioutlook16officenotificationmessages) | 成员 |
| [optionalAttendees](#optionalattendees-arrayemailaddressdetailsjavascriptapioutlook16officeemailaddressdetailsrecipientsjavascriptapioutlook16officerecipients) | 成员 |
| [organizer](#organizer-emailaddressdetailsjavascriptapioutlook16officeemailaddressdetails) | 成员 |
| [requiredAttendees](#requiredattendees-arrayemailaddressdetailsjavascriptapioutlook16officeemailaddressdetailsrecipientsjavascriptapioutlook16officerecipients) | 成员 |
| [sender](#sender-emailaddressdetailsjavascriptapioutlook16officeemailaddressdetails) | 成员 |
| [start](#start-datetimejavascriptapioutlook16officetime) | 成员 |
| [subject](#subject-stringsubjectjavascriptapioutlook16officesubject) | 成员 |
| [to](#to-arrayemailaddressdetailsjavascriptapioutlook16officeemailaddressdetailsrecipientsjavascriptapioutlook16officerecipients) | 成员 |
...
| [getEntities](#getentities--entitiesjavascriptapioutlook16officeentities) | 方法 |
| [getEntitiesByType](#getentitiesbytypeentitytype--nullable-arraystringcontactjavascriptapioutlook16officecontactmeetingsuggestionjavascriptapioutlook16officemeetingsuggestionphonenumberjavascriptapioutlook16officephonenumbertasksuggestionjavascriptapioutlook16officetasksuggestion) | 方法 |
| [getFilteredEntitiesByName](#getfilteredentitiesbynamename--nullable-arraystringcontactjavascriptapioutlook16officecontactmeetingsuggestionjavascriptapioutlook16officemeetingsuggestionphonenumberjavascriptapioutlook16officephonenumbertasksuggestionjavascriptapioutlook16officetasksuggestion) | 方法 |
...
| [getSelectedEntities](#getselectedentities--entitiesjavascriptapioutlook16officeentities) | 方法 |
...
#### <a name="attachments-arrayattachmentdetailsjavascriptapioutlook16officeattachmentdetails"></a>附件 :数组.<[AttachmentDetails](/javascript/api/outlook_1_6/office.attachmentdetails)>
...
*   数组。 <[AttachmentDetails](/javascript/api/outlook_1_6/office.attachmentdetails)>
...
|[适用 Outlook 模式](https://docs.microsoft.com/outlook/add-ins/#extension-points)| 阅读|
...
####  <a name="bcc-recipientsjavascriptapioutlook16officerecipients"></a>密件抄送：[收件人](/javascript/api/outlook_1_6/office.recipients)
...
|要求| 值|
|---|---|
|[最低邮箱要求设置版本](/javascript/office/requirement-sets/outlook-api-requirement-sets)| 1.1|
|[最低权限级别](https://docs.microsoft.com/outlook/add-ins/understanding-outlook-add-in-permissions)| ReadItem|
|[适用 Outlook 模式](https://docs.microsoft.com/outlook/add-ins/#extension-points)| 撰写|
...
####  <a name="body-bodyjavascriptapioutlook16officebody"></a>正文：[正文](/javascript/api/outlook_1_6/office.body)
...
####  <a name="cc-arrayemailaddressdetailsjavascriptapioutlook16officeemailaddressdetailsrecipientsjavascriptapioutlook16officerecipients"></a>抄送： 数组。 <[EmailAddressDetails](/javascript/api/outlook_1_6/office.emailaddressdetails)>|[收件人](/javascript/api/outlook_1_6/office.recipients)

提供对邮件抄送 (cc) 收件人的访问。 对象类型和访问级别取决于当前项的模式。
...
*   数组。 <[EmailAddressDetails](/javascript/api/outlook_1_6/office.emailaddressdetails)> |[收件人](/javascript/api/outlook_1_6/office.recipients)
...
####  <a name="end-datetimejavascriptapioutlook16officetime"></a>最终：日期 |[时间](/javascript/api/outlook_1_6/office.time)

获取或设置约会结束的日期和时间。

将 `end` 属性表示为协调世界时 (UTC) 的日期和时间值。可使用 [`convertToLocalClientTime`](office.context.mailbox.md#converttolocalclienttimetimevalue--localclienttimejavascriptapioutlook16officelocalclienttime) 方法将 end 属性值转换为客户端的本地日期和时间。
...
使用  方法设置结束时间时，应使用  方法将客户端的本地时间转换为服务器的 UTC。 [`Time.setAsync`](/javascript/api/outlook_1_6/office.time#setasync-datetime--options--callback-) [ `convertToUtcClientTime`  ](office.context.mailbox.md#converttoutcclienttimeinput--date)

##### <a name="type"></a>类型：

*   日期 | [时间](/javascript/api/outlook_1_6/office.time)
...
以下示例通过使用 `Time` 对象的 [`setAsync`](/javascript/api/outlook_1_6/office.time#setasync-datetime--options--callback-) 方法，设置撰写模式下约会的结束时间。
...
#### <a name="from-emailaddressdetailsjavascriptapioutlook16officeemailaddressdetails"></a>从：[EmailAddressDetails](/javascript/api/outlook_1_6/office.emailaddressdetails)

获取邮件发件人的电子邮件地址。仅限阅读模式。

`from` 和 [`sender`](#sender-emailaddressdetailsjavascriptapioutlook16officeemailaddressdetails) 属性表示同一个人，邮件由代理人发送的除外。在此情况下，`from` 属性表示代理程序，而 sender 属性表示代理人。
...
####  <a name="location-stringlocationjavascriptapioutlook16officelocation"></a>位置： 字符串 |[位置](/javascript/api/outlook_1_6/office.location)
...
*   字符串 | [位置](/javascript/api/outlook_1_6/office.location)
...
normalizedSubject 属性获取包含由电子邮件程序添加的任何标准前缀（如 `RE:` 和 `FW:`）的项目主题。若要获取包含完整前缀的项目主题，请使用 [`subject`](#subject-stringsubjectjavascriptapioutlook16officesubject) 属性。
...
|要求| 值|
|---|---|
|[最低邮箱要求设置版本](/javascript/office/requirement-sets/outlook-api-requirement-sets)| 1.3|
|[最低权限级别](https://docs.microsoft.com/outlook/add-ins/understanding-outlook-add-in-permissions)| ReadItem|
|[适用 Outlook 模式](https://docs.microsoft.com/outlook/add-ins/#extension-points)| 撰写或阅读|

####  <a name="optionalattendees-arrayemailaddressdetailsjavascriptapioutlook16officeemailaddressdetailsrecipientsjavascriptapioutlook16officerecipients"></a>optionalAttendees： 数组。 <[EmailAddressDetails](/javascript/api/outlook_1_6/office.emailaddressdetails)>|[收件人](/javascript/api/outlook_1_6/office.recipients)

提供对事件可选与会者的访问。 对象类型和访问级别取决于当前项的模式。
...
*   数组。 <[EmailAddressDetails](/javascript/api/outlook_1_6/office.emailaddressdetails)> |[收件人](/javascript/api/outlook/office.recipients)
...
#### <a name="organizer-emailaddressdetailsjavascriptapioutlook16officeemailaddressdetails"></a>组织者：[EmailAddressDetails](/javascript/api/outlook_1_6/office.emailaddressdetails)
...
####  <a name="requiredattendees-arrayemailaddressdetailsjavascriptapioutlook16officeemailaddressdetailsrecipientsjavascriptapioutlook16officerecipients"></a>requiredAttendees： 数组。 <[EmailAddressDetails](/javascript/api/outlook_1_6/office.emailaddressdetails)>|[收件人](/javascript/api/outlook_1_6/office.recipients)
...
#### <a name="sender-emailaddressdetailsjavascriptapioutlook16officeemailaddressdetails"></a>发件人：[EmailAddressDetails](/javascript/api/outlook_1_6/office.emailaddressdetails)

获取电子邮件发件人的电子邮件地址。仅限阅读模式。

[`from`](#from-emailaddressdetailsjavascriptapioutlook16officeemailaddressdetails) 和 `sender` 属性表示同一个人，邮件由代理人发送的除外。在此情况下，`from` 属性表示代理程序，而 sender 属性表示代理人。

> [!NOTE]
> `EmailAddressDetails` 对象的 `recipientType` 属性 在 `sender` 属性是 `undefined`。
...
####  <a name="start-datetimejavascriptapioutlook16officetime"></a>开始 ：日期 |[时间](/javascript/api/outlook_1_6/office.time)

获取或设置约会开始的日期和时间。

将 `start` 属性表示为协调世界时 (UTC) 的日期和时间值。可使用 [`convertToLocalClientTime`](office.context.mailbox.md#converttolocalclienttimetimevalue--localclienttimejavascriptapioutlook16officelocalclienttime) 方法将该值转换为客户端的本地日期和时间。
...
####  <a name="subject-stringsubjectjavascriptapioutlook16officesubject"></a>主题： 字符串 |[主题](/javascript/api/outlook_1_6/office.subject)
...
*   字符串 | [主题](/javascript/api/outlook_1_6/office.subject)
...
####  <a name="to-arrayemailaddressdetailsjavascriptapioutlook16officeemailaddressdetailsrecipientsjavascriptapioutlook16officerecipients"></a>发送： 数组。 <[EmailAddressDetails](/javascript/api/outlook_1_6/office.emailaddressdetails)>|[收件人](/javascript/api/outlook_1_6/office.recipients)

提供对邮件的 **发送** 行上收件人的访问。 对象类型和访问级别取决于当前项的模式。
...
|`attachmentName`| String||在附件上载过程中显示的附件名称。最大长度为 255 个字符。|
|`options`| 对象| &lt;可选&gt;|包含一个或多个以下属性的对象文本。|
| `options.asyncContext` | 对象 | &lt;可选&gt; | 开发人员可以提供他们想要在回调方法中访问的任何对象。 |
| `options.isInline` | Boolean | &lt;可选&gt; | 如果 `true` ，指示附件将嵌入在邮件正文中显示，而不应在附件列表中显示。 |
|`callback`| function| &lt;可选&gt;|此方法完成时，用单个参数调用 `callback` 参数中传递的函数，`asyncResult`，这是一个 [`AsyncResult`](/javascript/api/office/office.asyncresult) 对象。 <br/>如果成功，附件标识符将在 `asyncResult.value` 属性中提供。<br/>如果上传附件失败，`asyncResult` 对象将包含一个提供错误说明的 `Error` 对象。|
...
| `NumberOfAttachmentsExceeded` | 邮件或者约会具有太多附件。 |
...
|名称| 类型| 属性| 说明|
|---|---|---|---|
|`itemId`| String||要附加项目的 Exchange 标识符。最大长度为 100 个字符。|
|`attachmentName`| String||要附加项目的主题。最大长度为 255 个字符。|
|`options`| 对象| &lt;可选&gt;|包含一个或多个以下属性的对象文本。|
|`options.asyncContext`| 对象| &lt;可选&gt;|开发人员可以提供他们想要在回调方法中访问的任何对象。|
|`callback`| function| &lt;可选&gt;|此方法完成时，用单个参数调用 `callback` 参数中传递的函数，`asyncResult`，这是一个 [`AsyncResult`](/javascript/api/office/office.asyncresult) 对象。 <br/>如果成功，附件标识符将在 `asyncResult.value` 属性中提供。<br/>如果添加附件失败，`asyncResult` 对象将包含一个提供错误说明的 `Error` 对象。|
...
| 名称 | 类型 | 属性 | 说明 |
|---|---|---|---|
|`formData`| 字符串 | 对象| |一个包含文本和 HTML 且表示答复窗体正文的字符串。此字符串的大小被限制在 32 KB。<br/>**OR**<br/>包含正文或附件数据和回调函数的对象。对象定义如下。 |
| `formData.htmlBody` | String | &lt;可选&gt; | 一个包含文本和 HTML 且表示答复窗体正文的字符串。此字符串的大小被限制在 32 KB。
...
| `formData.attachments.url` | String | | 仅在 `type` 设置为 `file` 时才使用。文件位置的 URI 。 |
| `formData.attachments.isInline` | Boolean | | 仅在 `type` 设置为 `file` 时才使用。如果为 `true`，表示将在邮件正文中嵌入显示附件，并且不应在附件列表中显示。 |
| `formData.attachments.itemId` | String | | 仅在将 `type` 设置为 `item` 时使用。附件的 EWS 项目 ID。字符串最长为 100 个字符。 |
| `callback` | function | &lt;可选&gt; | 方法完成后，使用单个参数 `asyncResult`（一个 [AsyncResult](/javascript/api/office/office.asyncresult) 对象）调用在 `callback` 参数中传递的函数。 |
...
#### <a name="getentities--entitiesjavascriptapioutlook16officeentities"></a>getEntities() → {[实体](/javascript/api/outlook_1_6/office.entities)}
...
类型： [实体](/javascript/api/outlook_1_6/office.entities)
...
如果在 `entityType` 中传递的值不是 `EntityType` 枚举的有效成员，该方法返回 null。 如果指定类型的任何实体都不存在于该项目上，该方法将返回空数组。 否则，返回数组中的对象类型取决于 `entityType` 参数中请求实体的类型。

当使用此方法的最低权限级别为 **Restricted** 时，一些实体类型需要 **ReadItem** 才能进行访问，如下表中所指定。

| 值对应于 `entityType` | 返回数组中对象的类型 | 所需权限级别 |
| --- | --- | --- |
...
如果在项目的正文属性上指定 `ItemHasRegularExpressionMatch` 规则，则正则表达式应进一步筛选正文，不应尝试返回该项目的整个正文。使用正则表达式（如 `.*`）获取项目的整个正文并不总是返回预期的结果。而该使用 [`Body.getAsync`](/javascript/api/outlook_1_6/office.body#getasync-coerciontype--options--callback-) 方法检索整个正文。
...
包含字符串数组的对象，该字符串与清单 XML 文件定义的正则表达式相匹配。每个数组的名称等于匹配 `ItemHasRegularExpressionMatch` 规则的 `RegExName` 属性或者匹配 `ItemHasKnownEntity` 规则的 `FilterName` 属性的相应的值。
...
#### <a name="getregexmatchesbynamename--nullable-array-string-"></a>getRegExMatchesByName( 名称 ) → ( 可为空) { 数组。< String >}
...
|`options`| 对象| &lt;可选&gt;|包含一个或多个以下属性的对象文本。|
|`options.asyncContext`| 对象| &lt;可选&gt;|开发人员可以提供他们想要在回调方法中访问的任何对象。|
|`callback`| function||此方法完成时，用单个参数调用 `callback` 参数中传递的函数，`asyncResult`，这是一个 [`AsyncResult`](/javascript/api/office/office.asyncresult) 对象。<br/><br/>若要从回调方法访问所选数据，请调用 `asyncResult.value.data`。 若要访问选定内容的源属性，请调用 `asyncResult.value.sourceProperty` ，这将为 `body`    或 `subject` 。||

##### <a name="requirements"></a>要求

|要求| 值|
|---|---|
|[最低邮箱要求设置版本](/javascript/office/requirement-sets/outlook-api-requirement-sets)| 1.2|
|[最低权限级别](https://docs.microsoft.com/outlook/add-ins/understanding-outlook-add-in-permissions)| ReadWriteItem|
|[适用 Outlook 模式](https://docs.microsoft.com/outlook/add-ins/#extension-points)| 撰写|
...
#### <a name="getselectedentities--entitiesjavascriptapioutlook16officeentities"></a>getSelectedEntities() → {[实体](/javascript/api/outlook_1_6/office.entities)}

从用户所选突出显示的匹配项中获取实体。突出显示的匹配项应用于[上下文加载项](https://docs.microsoft.com/outlook/add-ins/contextual-outlook-add-ins) 。
...
|要求| 值|
|---|---|
|[最低邮箱要求设置版本](/javascript/office/requirement-sets/outlook-api-requirement-sets)| 1.6 |
|[最低权限级别](https://docs.microsoft.com/outlook/add-ins/understanding-outlook-add-in-permissions)| ReadItem|
|[适用 Outlook 模式](https://docs.microsoft.com/outlook/add-ins/#extension-points)| 阅读|
...
以下示例访问用户所选突出显示匹配项中的地址实体。

```
var contacts = Office.context.mailbox.item.getSelectedEntities().addresses;
```

#### <a name="getselectedregexmatches--object"></a>getSelectedRegExMatches() → { 对象 }

返回与清单 XML 文件中定义的正则表达式相匹配的突出显示匹配项中的字符串值。突出显示匹配项应用于[上下文加载项](https://docs.microsoft.com/outlook/add-ins/contextual-outlook-add-ins) 。
...
|名称| 类型| 属性| 说明|
|---|---|---|---|
|`callback`| function||此方法完成时，用单个参数调用 `callback` 参数中传递的函数，`asyncResult`，这是一个 [`AsyncResult`](/javascript/api/office/office.asyncresult) 对象。<br/><br/>自定义属性作为 `asyncResult.value` 属性中的 [`CustomProperties`](/javascript/api/outlook_1_6/office.customproperties) 对象来提供。 此对象可用于获取、 设置、并从项目中删除自定义属性，并将更改保存到自定义属性设置回服务器。|
...
|名称| 类型| 属性| 说明|
|---|---|---|---|
|`attachmentId`| String||要删除的附件的标识符。字符串的最大长度为 100 个字符。|
|`options`| 对象| &lt;可选&gt;|包含一个或多个以下属性的对象文本。|
|`options.asyncContext`| 对象| &lt;可选&gt;|开发人员可以提供他们想要在回调方法中访问的任何对象。|
|`callback`| function| &lt;可选&gt;|此方法完成时，用单个参数调用 `callback` 参数中传递的函数，`asyncResult`，这是一个 [`AsyncResult`](/javascript/api/office/office.asyncresult) 对象。 <br/>如果删除附件失败，`asyncResult.error` 属性将包含一个说明失败原因的错误代码。|
...
|`options`| 对象| &lt;可选&gt;|包含一个或多个以下属性的对象文本。|
|`options.asyncContext`| 对象| &lt;可选&gt;|开发人员可以提供他们想要在回调方法中访问的任何对象。|
|`callback`| function||此方法完成时，用单个参数调用 `callback` 参数中传递的函数，`asyncResult`，这是一个 [`AsyncResult`](/javascript/api/office/office.asyncresult) 对象。<br/><br/>如果成功，该项目标识符在 `asyncResult.value` 属性中提供。|
...
|`callback`| function||此方法完成时，用单个参数调用 `callback` 参数中传递的函数，`asyncResult`，这是一个 [`AsyncResult`](/javascript/api/office/office.asyncresult) 对象。 |
