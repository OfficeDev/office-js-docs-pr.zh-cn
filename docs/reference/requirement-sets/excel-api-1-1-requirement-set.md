...
下表列出了 JavaScript API 要求集 1.1 Excel中的 API。 若要查看 JavaScript API 要求集 1.1 Excel所有 API 的 API 参考文档，请参阅要求集[1.1](/javascript/api/excel?view=excel-js-1.1&preserve-view=true)中的 Excel API。
