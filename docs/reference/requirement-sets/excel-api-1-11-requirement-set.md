...
| [剪切并粘贴 (moveTo) ](../../excel/excel-add-ins-ranges-cut-copy-paste.md) | 复制 Range Excel中的剪切和粘贴功能。 | [区域](/javascript/api/excel/excel.range) |
...
||[名称](/javascript/api/excel/excel.commentmention#name)|注释中提到的实体的名称。|
...
|[CultureInfo](/javascript/api/excel/excel.cultureinfo)|[名称](/javascript/api/excel/excel.cultureinfo#name)|获取语言代码 2-国家/地区代码2 格式的区域性名称 (例如，"zh-cn"或"en-us") 。|
