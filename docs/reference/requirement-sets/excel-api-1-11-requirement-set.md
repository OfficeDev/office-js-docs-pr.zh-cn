...
| [剪切和粘贴（moveTo）](../../excel/excel-add-ins-ranges-advanced.md#cut-copy-and-paste) | 在 Excel 中复制区域的剪切和粘贴功能。 | [Range](/javascript/api/excel/excel.range) |
...
下表列出了 Excel JavaScript API 要求集1.11 中的 Api。 若要查看 Excel JavaScript API 要求集1.11 或更早版本支持的所有 Api 的 API 参考文档，请参阅[要求集1.11 或更早版本中的 Excel api](/javascript/api/excel?view=excel-js-1.11)。
...
|[Comment](/javascript/api/excel/excel.comment)|[提及](/javascript/api/excel/excel.comment#mentions)|获取注释中提到的实体（例如，人员）。|
