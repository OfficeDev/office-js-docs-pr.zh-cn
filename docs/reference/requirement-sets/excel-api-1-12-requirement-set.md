...
| 功能区域 | 说明 | 相关对象 |
|:--- |:--- |:--- |
| [注释事件](../../excel/excel-add-ins-comments.md#comment-events) | 将添加、更改和删除的事件添加到注释集合中。| [CommentCollection](/javascript/api/excel/excel.commentcollection) |
...
| [直接引用单元格](../../excel/excel-add-ins-ranges-advanced.md#get-formula-precedents) | 返回用于计算单元格的公式的范围。| [Range](/javascript/api/excel/excel.range#getdirectprecedents--) |
...
| [区域 spilling](../../excel/excel-add-ins-ranges-advanced.md#handle-dynamic-arrays-and-spilling) | 允许外接程序查找与 [动态数组](https://support.microsoft.com/office/205c6b06-03ba-4151-89a1-87a7eb36e531) 结果关联的范围。 | [Range](/javascript/api/excel/excel.range) |
...
|[CultureInfo](/javascript/api/excel/excel.cultureinfo)|[datetimeFormat](/javascript/api/excel/excel.cultureinfo#datetimeformat)|定义适当的区域性格式，以显示日期和时间。|
...
|[PivotDateFilter](/javascript/api/excel/excel.pivotdatefilter)|[运算符](/javascript/api/excel/excel.pivotdatefilter#comparator)|比较运算符是其他值要与其进行比较的静态值。|
||[表达式](/javascript/api/excel/excel.pivotdatefilter#condition)|指定筛选器的条件，该条件定义了必要的筛选条件。|
||[异](/javascript/api/excel/excel.pivotdatefilter#exclusive)|如果为 true，则筛选 *排除* 满足条件的项目。|
...
||[clearAllFilters ( # B1 ](/javascript/api/excel/excel.pivotfield#clearallfilters--)|从字段的所有筛选器中清除所有条件。|
...
||[manualFilter](/javascript/api/excel/excel.pivotfilters#manualfilter)|透视字段当前应用的手动筛选。|
||[valueFilter](/javascript/api/excel/excel.pivotfilters#valuefilter)|透视字段当前应用的值筛选器。|
|[PivotLabelFilter](/javascript/api/excel/excel.pivotlabelfilter)|[运算符](/javascript/api/excel/excel.pivotlabelfilter#comparator)|比较运算符是其他值要与其进行比较的静态值。|
...
|[PivotValueFilter](/javascript/api/excel/excel.pivotvaluefilter)|[运算符](/javascript/api/excel/excel.pivotvaluefilter#comparator)|比较运算符是其他值要与其进行比较的静态值。|
||[表达式](/javascript/api/excel/excel.pivotvaluefilter#condition)|指定筛选器的条件，该条件定义了必要的筛选条件。|
||[异](/javascript/api/excel/excel.pivotvaluefilter#exclusive)|如果为 true，则筛选 *排除* 满足条件的项目。|
...
|[Range](/javascript/api/excel/excel.range)|[getDirectPrecedents ( # B1 ](/javascript/api/excel/excel.range#getdirectprecedents--)|返回一个 WorkbookRangeAreas 对象，该对象代表包含同一工作表或多个工作表中的单元格的所有直接引用单元格的区域。|
...
|[WorksheetCustomPropertyCollection](/javascript/api/excel/excel.worksheetcustompropertycollection)|[add (key： string，value： string) ](/javascript/api/excel/excel.worksheetcustompropertycollection#add-key--value-)|添加映射到所提供的键的新自定义属性。|
