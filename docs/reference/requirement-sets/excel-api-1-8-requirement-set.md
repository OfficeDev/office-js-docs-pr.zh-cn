...
|[ChartPlotArea](/javascript/api/excel/excel.chartplotarea)|[height](/javascript/api/excel/excel.chartplotarea#height)|指定绘图区的高度值。|
...
||[format](/javascript/api/excel/excel.chartplotarea#format)|指定图表绘图区的格式。|
...
|[FilterPivotHierarchyCollection](/javascript/api/excel/excel.filterpivothierarchycollection)|[添加 (pivotHierarchy： Excel。PivotHierarchy) ](/javascript/api/excel/excel.filterpivothierarchycollection#add_pivotHierarchy_)|将 PivotHierarchy 添加到当前轴。|
...
|[PivotTable](/javascript/api/excel/excel.pivottable)|[delete()](/javascript/api/excel/excel.pivottable#delete__)|删除 PivotTable 对象。|
...
|[RowColumnPivotHierarchyCollection](/javascript/api/excel/excel.rowcolumnpivothierarchycollection)|[添加 (pivotHierarchy： Excel。PivotHierarchy) ](/javascript/api/excel/excel.rowcolumnpivothierarchycollection#add_pivotHierarchy_)|将 PivotHierarchy 添加到当前轴。|
