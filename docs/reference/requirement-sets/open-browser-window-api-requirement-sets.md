---
title: 打开浏览器窗口要求集
description: 指定哪些Office和内部版本支持 openBrowserWindow API。
ms.date: 04/09/2021
...
|  要求集  | Office 2013 或更高版本Windows 2013<br>（一次性购买） | Windows 版 Office<br>（关联至 Microsoft 365 订阅） |  iPad 版 Office<br>（关联至 Microsoft 365 订阅）  |  Mac 版 Office<br>（关联至 Microsoft 365 订阅）  | Office 网页版  |  Office Online Server  |
|:-----|-----|:-----|:-----|:-----|:-----|:-----|:-----|
...
- [在哪里可以找到客户端应用程序的版本号Office版本号](https://support.office.com/article/version-and-build-numbers-of-update-channel-releases-ae942449-1fca-4484-898b-a933ea23def7)
