...
|[Document](/javascript/api/word/word.document)|[body](/javascript/api/word/word.document#body)|获取主文档的 body 对象。|
||[contentControls](/javascript/api/word/word.document#contentControls)|获取文档中的内容控件对象的集合。|
||[getSelection () ](/javascript/api/word/word.document#getSelection__)|获取文档的当前选定内容。|
...
|[Section](/javascript/api/word/word.section)|[body](/javascript/api/word/word.section#body)|获取节的 body 对象。|
||[getFooter (类型：Word.HeaderFooterType) ](/javascript/api/word/word.section#getFooter_type_)|获取节的页脚之一。|
