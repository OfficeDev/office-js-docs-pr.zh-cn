...
|[List](/javascript/api/word/word.list)|[getLevelParagraphs (级别：number) ](/javascript/api/word/word.list#getLevelParagraphs_level_)|获取列表中指定级别的段落。|
...
|[TableRow](/javascript/api/word/word.tablerow)|[clear()](/javascript/api/word/word.tablerow#clear__)|清除行内容。|
