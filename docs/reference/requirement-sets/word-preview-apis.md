...
| 类 | 域 | 说明 |
|:---|:---|:---|
|[正文](/javascript/api/word/word.body)|[getComments () ](/javascript/api/word/word.body#getComments__)|获取与正文关联的注释。|
||[endnotes](/javascript/api/word/word.body#endnotes)|获取正文中的尾注集合。|
||[脚注](/javascript/api/word/word.body#footnotes)|获取正文中的脚注集合。|
||[type](/javascript/api/word/word.body#type)|获取 body 的类型。|
|[Comment](/javascript/api/word/word.comment)|[content](/javascript/api/word/word.comment#content)|Gtes 或设置批注的内容为纯文本。|
...
||[authorEmail](/javascript/api/word/word.comment#authorEmail)|获取批注作者的电子邮件。|
...
|[CommentReply](/javascript/api/word/word.commentreply)|[content](/javascript/api/word/word.commentreply#content)|获取或设置批注回复的内容。|
||[delete()](/javascript/api/word/word.commentreply#delete__)|删除批注回复。|
||[authorEmail](/javascript/api/word/word.commentreply#authorEmail)|获取批注回复作者的电子邮件。|
...
|[ContentControl](/javascript/api/word/word.contentcontrol)|[getComments () ](/javascript/api/word/word.contentcontrol#getComments__)|获取与正文关联的注释。|
||[endnotes](/javascript/api/word/word.contentcontrol#endnotes)|获取 contentcontrol 中的尾注集合。|
||[脚注](/javascript/api/word/word.contentcontrol#footnotes)|获取 contentcontrol 中的脚注集合。|
||[onDataChanged](/javascript/api/word/word.contentcontrol#onDataChanged)|更改内容控件内的数据时发生。|
...
|[Document](/javascript/api/word/word.document)|[deleteBookmark (name： string) ](/javascript/api/word/word.document#deleteBookmark_name_)|从文档中删除书签（如果存在）。|
...
||[getEndnoteBody () ](/javascript/api/word/word.document#getEndnoteBody__)|获取文档的尾注的正文。|
...
|[DocumentCreated](/javascript/api/word/word.documentcreated)|[deleteBookmark (name： string) ](/javascript/api/word/word.documentcreated#deleteBookmark_name_)|从文档中删除书签（如果存在）。|
...
|[NoteItem](/javascript/api/word/word.noteitem)|[delete()](/javascript/api/word/word.noteitem#delete__)|删除便笺项目。|
...
||[body](/javascript/api/word/word.noteitem#body)|表示便笺项目的 body 对象。|
...
|[Paragraph](/javascript/api/word/word.paragraph)|[getComments () ](/javascript/api/word/word.paragraph#getComments__)|获取与段落关联的注释。|
||[endnotes](/javascript/api/word/word.paragraph#endnotes)|获取 Paragraph 中的尾注集合。|
...
||[endnotes](/javascript/api/word/word.range#endnotes)|获取 Range 中的尾注集合。|
...
||[endnotes](/javascript/api/word/word.table#endnotes)|获取 table 中的尾注集合。|
...
||[endnotes](/javascript/api/word/word.tablerow#endnotes)|获取表格行中的尾注集合。|
