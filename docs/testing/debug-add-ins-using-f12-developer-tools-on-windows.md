---
title: 在加载项上使用开发人员工具调试Windows
description: 使用开发人员工具Microsoft Edge加载项Windows
ms.date: 10/05/2021
...
ms.locfileid: "60138806"
---
# <a name="debug-add-ins-using-developer-tools-on-windows"></a>在加载项上使用开发人员工具调试Windows

IDES 之外的开发人员工具可以帮助你在 11 和 11 上调试Windows 10加载项。 当你在 IDE 之外运行加载项的同时，需要调查问题时，这些工具非常有用。

所使用的工具取决于加载项是在 Microsoft Edge 还是在 Internet Explorer 中运行。 这由 Windows 的版本和Office安装的版本决定。 若要确定开发计算机上使用的浏览器，请参阅 [Office 加载项使用的浏览器](../concepts/browsers-used-by-office-web-add-ins.md)。
...
当外接程序在 Internet Explorer 中运行时，您可以使用 Windows 中的 F12 开发人员工具中的调试器来测试外接程序。 运行加载项后，可以启动 F12 开发人员工具。 F12 工具显示在单独的窗口中，并不使用 Visual Studio。

> [!NOTE]
> 调试器是 Windows 10、11 和 Internet Explorer 中的 F12 开发人员工具的一Internet Explorer。 较低版本的 Windows 不包含调试器。 
