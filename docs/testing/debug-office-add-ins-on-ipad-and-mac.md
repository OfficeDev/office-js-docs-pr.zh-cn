...
若要能够在 Mac Office加载项，你必须拥有 Mac OS High Sierra 和 Mac Office 版本 16.9.1 (版本18012504) 更高版本。 如果你没有 Mac Office，可以通过加入开发人员计划Microsoft 365[一个](https://developer.microsoft.com/office/dev-program)。
