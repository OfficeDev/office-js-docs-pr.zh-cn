...
1. 在 `insertParagraph()` 函数中，将 `TODO1` 替换为以下代码。 注意：
...
1. 在 Word 中，创建[自定义样式](https://support.office.com/article/customize-or-create-new-styles-d38d6e47-f6fc-48eb-a607-1eb120dec563)“MyCustomStyle”。其中可以包含所需的任何格式。
