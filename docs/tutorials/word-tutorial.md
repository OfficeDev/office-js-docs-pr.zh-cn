...
2. 定位 `<button>` 按钮的 `insert-paragraph` 元素，并在行后添加下列标记：
...
2. 定位 `<button>` 按钮的 `apply-style` 元素，并在行后添加下列标记：
...
2. 定位 `<button>` 按钮的 `apply-custom-style` 元素，并在行后添加下列标记：
...
2. 定位 `<button>` 按钮的 `change-font` 元素，并在行后添加下列标记：
...
2. 定位 `<button>` 按钮的 `insert-text-into-range` 元素，并在行后添加下列标记：
...
2. 定位 `<button>` 按钮的 `replace-text` 元素，并在行后添加下列标记：
...
2. 定位 `<button>` 按钮的 `insert-image` 元素，并在行后添加下列标记：
...
2. 定位 `<button>` 按钮的 `insert-html` 元素，并在行后添加下列标记：
...
2. 定位 `<button>` 按钮的 `insert-table` 元素，并在行后添加下列标记：
...
2. 定位 `<button>` 按钮的 `create-content-control` 元素，并在行后添加下列标记：
