...
借助 Word 加载项，你可以使用熟悉的 Web 技术（如 HTML、CSS 和 JavaScript）来构建一个可跨多个平台（包括在 Windows、Mac、iPad 和 Web 浏览器上）在 Word 中运行的解决方案。 了解如何构建、测试、调试和发布 Word 加载项。
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>概述</h3>
                        <p><a href="word-add-ins-programming-overview.md">了解 Word 加载项的组件和功能。</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>入门</h3>
                        <p><a href="../quickstarts/word-quickstart.md">在 5 分钟内生成首个 Word 加载项</a>，然后<a href="../overview/explore-with-script-lab.md">使用 Script Lab 探索 API</a>。</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p><a href="../reference/overview/word-add-ins-reference-overview.md">了解如何使用 Word JavaScript API 与 Word 中的文档内容和元数据交互。</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>测试和调试</h3>
                        <p><a href="../testing/test-debug-office-add-ins.md">了解如何测试和调试 Word 加载项。</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>发布</h3>
                        <p><a href="../publish/publish.md">了解如何部署和发布 Word 加载项。</a></p>
                    </div>
                </div>
            </div>
        </div>
